                    ...
                    <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                        ...
                        <h3 class="card-title align-items-start flex-column text-white pt-15">
                            ...
                            <div class="fs-4 text-white">
                                ...
                                <span class="position-relative d-inline-block">
                                    <a href="/../demo1/pages/user-profile/projects.html"
                        ...
                        <div class="card-toolbar pt-5">
                            ...
                            <button
                                ...
                                <i class="ki-duotone ki-dots-square fs-4"><span
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h4 class="card-title d-flex align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Today’s
                                        Course</span>
                                    <span class="text-gray-500 mt-1 fw-bold fs-7">4 lessons, 3 hours
                                        45 minutes</span>
                                </h4>
                                <!--end::Title-->
                            ...
                            <div class="card-body py-6">
                                ...
                                <div class="carousel-inner mt-n5">
                                    ...
                                    <div class="carousel-item active show">
                                        ...
                                        <div class="m-0">
                                            <a href="#"
                                                class="btn btn-sm btn-light me-2 mb-2">Skip This</a>
                                        ...
                                        <div class="d-flex align-items-center mb-9">
                                            ...
                                            <div class="symbol symbol-70px symbol-circle me-5">
                                                <span class="symbol-label bg-light-success">
                                                    <i
                                                        class="ki-duotone ki-abstract-24 fs-3x text-success"><span
                                                            class="path1"></span><span
                                                            class="path2"></span></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center mb-9">
                                            ...
                                            <div class="symbol symbol-70px symbol-circle me-5">
                                                <span class="symbol-label bg-light-danger">
                                                    <i
                                                        class="ki-duotone ki-abstract-25 fs-3x text-danger"><span
                                                            class="path1"></span><span
                                                            class="path2"></span></i>
                                                </span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center mb-9">
                                            ...
                                            <div class="symbol symbol-70px symbol-circle me-5">
                                                <span class="symbol-label bg-light-primary">
                                                    <i
                                                        class="ki-duotone ki-abstract-36 fs-3x text-primary"><span
                                                            class="path1"></span><span
                                                            class="path2"></span></i>
                                                </span>
                                            </div>
                    ...
                    <div class="card-body d-flex ps-xl-15">
                        ...
                        <div class="m-0">
                            ...
                            <div class="mb-3">
                                ...
                                <a href="/../demo1/apps/support-center/overview.html"
                ...
                <div class="card h-xl-100">
                    ...
                    <div class="card-body pt-6">
                        ...
                        <div class="d-flex flex-stack">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-40px me-4">
                                <div class="symbol-label fs-2 fw-semibold bg-info text-inverse-info">W
                                </div>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex flex-stack">
                            <!--begin::Symbol-->
                            <div class="symbol symbol-40px me-4">
                                <div class="symbol-label fs-2 fw-semibold bg-dark text-inverse-dark">M
                                </div>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <!--begin::Description-->
                                    <span class="text-gray-500 fw-semibold d-block fs-6">PHP
                                        Framework</span>
                                    <!--end::Description--->
                                </div>
                                <!--end::Section-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <!--begin::Description-->
                                    <span class="text-gray-500 fw-semibold d-block fs-6">JS
                                        Framework</span>
                                    <!--end::Description--->
                                </div>
                                <!--end::Section-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <!--begin::Description-->
                                    <span class="text-gray-500 fw-semibold d-block fs-6">CSS
                                        Framework</span>
                                    <!--end::Description--->
                                </div>
                                <!--end::Section-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <!--begin::Description-->
                                    <span class="text-gray-500 fw-semibold d-block fs-6">Java
                                        Framework</span>
                                    <!--end::Description--->
                                </div>
                                <!--end::Section-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <!--begin::Description-->
                                    <span class="text-gray-500 fw-semibold d-block fs-6">Better
                                        Tooling</span>
                                    <!--end::Description--->
                                </div>
                                <!--end::Section-->
